...
export const PRODUCT_CARD_COMPONENT = ({ product }: { product: ProductoType }) => {
    ...
    return (
        <div className="shadow-neutral-800 bg-neutral-500 bg-opacity-30 md:bg-opacity-30 dark:bg-neutral-600 dark:bg-opacity-50 backdrop-blur-md rounded-md p-4 flex flex-col">
